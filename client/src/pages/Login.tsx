...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Welcome to Workit.OS!",
      });
    } catch (error: any) {
      toast({
        title: "Error",
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <GlassCard className="p-6 space-y-6">
          ...
          <div className="relative">
            <Separator />
            <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800 px-2 text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="text-center text-sm">
            ...
            <Button variant="link" className="p-0 h-auto text-indigo-500 hover:text-indigo-600">
